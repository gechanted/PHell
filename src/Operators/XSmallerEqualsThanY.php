...
use PHell\Flow\Exceptions\XSmallerEqualsThanYException;
...
class XSmallerEqualsThanY extends EasyStatement
{
    ...
    public function getValue(RunningFunction $currentEnvironment, CodeExceptionHandler $exHandler): ReturnLoad
    {
        ...
        if ($floatValidator->validate($x)->isSuccess() && $floatValidator->validate($y)->isSuccess()) {
            ...
            $exResult = $exHandler->handle(new XSmallerEqualsThanYException([$x, $y]));
